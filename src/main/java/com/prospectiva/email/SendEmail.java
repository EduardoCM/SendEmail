...
public class SendEmail {
	...
	final String senderEmailID = "correoEnvia@gmail.com";
	final String senderPassword = "secret";
	 ...
	 * y permitir el acceso a aplicaciones menos seguras.
	 * @param args
	 */
	public static void main(String[] args) {
		System.out.println(":::: Start");
		SendEmail sendEmail = new SendEmail("eduardo.castillo@prospectiva.com.mx", "Correo con Java Mail", "Este es un correo de prueba");
